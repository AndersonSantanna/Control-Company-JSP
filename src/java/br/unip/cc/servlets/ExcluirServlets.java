 ...
 */
@WebServlet(name = "ExcluirServlets", urlPatterns = {"/excluir"})
public class ExcluirServlets extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            empresa = ge.getPorId(Integer.parseInt(id));
            
            ge.remover(empresa);
            list = ge.getTodasEmpresa();
        } catch (DaoException ex) {
            String mensagem = "empresa: " + empresa.getRazaoSocial()
                    + " desejada (id=" + id + ")";
